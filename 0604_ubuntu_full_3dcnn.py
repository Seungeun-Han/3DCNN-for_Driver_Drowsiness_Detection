...
if __name__=='__main__':
    ...
    train_label = np.load('../../Dataset/SEV1_Labels_f16p8_gc_lefteye.npy')
    #linput, left_model = lefteye_Train(lefteye_train_data)

    mouth_train_data = np.load("../../Dataset/SEV1_Inputs_f16p8_gc_mouth.npy")
    #minput, mouth_model = mouth_Train(mouth_train_data)

    righteye_train_data = np.load("../../Dataset/SEV1_Inputs_f16p8_gc_righteye.npy")
    ...
    with mirrored_strategy.scope():
        ...
        right_model = tf.keras.Sequential([
            Input(righteye_train_data.shape[1:]),
            Conv3D(32, kernel_size=(3, 3, 3), input_shape=(righteye_train_data.shape[1:]), padding="same"),
            Activation('relu'),
            Conv3D(32, padding="same", kernel_size=(3, 3, 3)),
            Activation('relu'),
            Dropout(0.25),
        ...
        final_model = Dense(512, activation='relu')(left_model)
