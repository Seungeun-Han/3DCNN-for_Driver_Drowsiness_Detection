...
if __name__=='__main__':
    ...
    parser.add_argument('--part', type=str, default='righteye')
    ...
    train_data = np.load("../../NK_Data/Inputs_f16p8_00089892_righteye.npy")
    label = np.load('../../NK_Data/Labels_f16p8_00089892_righteye.npy')
    ...
    righteye_eval_data = np.load("../../Dataset/Val_Inputs_f16p8_00021123_right_eye.npy")
    eval_label = np.load('../../Dataset/Val_Labels_f16p8_00021123_right_eye.npy')

    history = model.fit(train_data, label, validation_data=(righteye_eval_data, eval_label), batch_size=args.batch,
                        epochs=args.epoch, verbose=1, shuffle=True)

    loss, acc = model.evaluate(righteye_eval_data, eval_label, verbose=1)
    print('Test loss:', loss)
    print('Test accuracy:', acc)
