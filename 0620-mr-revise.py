...
if __name__=='__main__':
    ...
    parser.add_argument('--batch', type=int, default=64)          ### 수정 ###
    ...
    parser.add_argument('--fovp', type=str, default='_f10ovp5')    ### 수정 ###
    ...
    # face_train_data = np.load("../Dataset/Train_Concat/Inputs_f16p0_00044646_064_face.npy")            ### 수정 ###
    mouth_train_data = np.load("../Dataset/Train_Concat/Inputs_f10p5_00142876_mouth.npy")           ### 수정 ###
    righteye_train_data = np.load("../Dataset/Train_Concat/Inputs_f10p5_00142876_righteye.npy")     ### 수정 ###
