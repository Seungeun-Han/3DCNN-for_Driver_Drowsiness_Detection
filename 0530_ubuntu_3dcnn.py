...
if __name__=='__main__':
    ...
    parser.add_argument('--part', type=str, default='lefteye')
    ...
    train_data = np.load("../../Dataset/SEV1_Inputs_f16p8_gc_lefteye.npy")
    label = np.load('../../Dataset/SEV1_Labels_f16p8_gc_lefteye.npy')
